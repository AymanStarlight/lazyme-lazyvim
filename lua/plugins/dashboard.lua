return {
  ...
  config = function()
    ...
    dashboard.section.header.val = get_header(8, false) -- (index, bool) index of ascii art bool if you want random or not eg: (30, false)
    dashboard.section.buttons.val = {
      button("f", icons.ui.files .. " Find Files", ":<cmd> lua LazyVim.pick()() <cr>"),
      button("n", icons.ui.new_file .. " New file", [[<cmd> ene <BAR> startinsert <cr>]]),
      button("r", icons.ui.restore .. " Recent Files", [[<cmd> lua LazyVim.pick("oldfiles")() <cr>]]),
      button("g", icons.kinds.nvchad.Text .. " Find text", [[<cmd> lua LazyVim.pick("live_grep")() <cr>]]),
      button("c", " " .. " Neovim config", "<cmd> lua LazyVim.pick.config_files()() <cr>"),
    ...
    local function footer()
      ...
      local ms = icons.kinds.new.Event .. (math.floor(stats.startuptime * 100 + 0.5) / 100)
